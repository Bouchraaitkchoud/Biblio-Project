 ...
 */
final class Version20251105081354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecteur ADD force_password_change TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecteur DROP force_password_change');
