 ...
 */
final class Version20251017084512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, placed_at DATETIME NOT NULL, processed_at DATETIME DEFAULT NULL, status VARCHAR(20) NOT NULL, receipt_code VARCHAR(50) DEFAULT NULL, order_details JSON DEFAULT NULL, admin_email VARCHAR(100) DEFAULT NULL, INDEX IDX_E52FFDEEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
