 ...
 */
final class Version20250417113433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD description LONGTEXT DEFAULT NULL, CHANGE cover_image cover_image LONGBLOB DEFAULT NULL, CHANGE isbn isbn VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP description, CHANGE cover_image cover_image MEDIUMBLOB DEFAULT NULL, CHANGE isbn isbn VARCHAR(30) DEFAULT NULL');
    }
}
