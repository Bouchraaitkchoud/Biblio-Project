 ...
 */
final class Version20251119101314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE system_config (id INT AUTO_INCREMENT NOT NULL, `key` VARCHAR(255) NOT NULL, value VARCHAR(1000) NOT NULL, description VARCHAR(500) DEFAULT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_C4049ABD8A90ABA9 (`key`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('DROP INDEX cart_id_UNIQUE ON receipt');
        $this->addSql('ALTER TABLE receipt CHANGE order_id order_id INT NOT NULL, CHANGE code code VARCHAR(50) NOT NULL, CHANGE generated_at generated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE receipt CHANGE order_id order_id INT DEFAULT NULL, CHANGE code code TEXT NOT NULL, CHANGE generated_at generated_at TEXT NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX cart_id_UNIQUE ON receipt (order_id)');
